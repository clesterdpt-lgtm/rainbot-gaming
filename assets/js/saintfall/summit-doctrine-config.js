...
const AUTHORED_PLATES = new Set([
  ...
  "vigil_last_lantern",
  "vigil_white_vigil",
  "antiphon_swift_verse",
  "antiphon_answering_step",
  "antiphon_wider_verse",
  "antiphon_lingering_verse",
  "antiphon_the_response",
  "bulwark_anvil_stance",
  "bulwark_bell_and_board",
  "bulwark_returned_weight",
  "bulwark_immovable",
  "bulwark_the_shut_gate",
  "cast_true_return",
  "cast_iron_bell",
  "cast_second_reliquary",
  "cast_hooked_chain",
  "cast_the_thrown_choir",
  "forge_stoked",
  "forge_hard_landing",
  "forge_bellows",
  "forge_furnace_gait",
  "forge_the_open_firebox",
  "anvil_dead_weight",
