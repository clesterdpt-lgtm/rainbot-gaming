...
- An eight-screen 4×2 monitor bank cycles through all 34 public cameras. Each low-resolution feed copies its source camera's live lens/yaw/pitch, uses a legible green low-light pass, refreshes one target at a time, and freezes when the player leaves the Workroom vicinity.
