...
(() => {
  ...
  const BUILD = "20260814-apostate-cathedral-1";
  ...
  const MODULES = [
    ...
    "mission", "breaches", "coulter", "distaff", "winnower", "apostate", "progression-config", "progression", "audio", "hud", "touch", "intro", "pod", "save", "ui", "qa", "main",
  ];
