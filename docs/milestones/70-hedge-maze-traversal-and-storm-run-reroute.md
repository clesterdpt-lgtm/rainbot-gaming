...
- [x] The relocated final-straight apparition remains life-size, facing the player, unobstructed, darkness-synchronized, and followed by a rear-exit practical that stays dark until the player leaves the maze. — test: `scripts/test-mr-feast-storm-run.mjs::mapped facing-gated desktop, interrupted-audio, and phone scares`
