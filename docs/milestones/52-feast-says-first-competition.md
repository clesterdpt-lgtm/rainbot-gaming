...
- A visible Ballroom reporting station, four contestant marks, staged Mr. Feast and contestant positions, and a responsive minimal status strip that shows only the event, round, and remaining time.
