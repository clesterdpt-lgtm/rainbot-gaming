	...
	*/
	...
	class GLTFTextureTransformExtension {
		...
		extendTexture( texture, transform ) {
			...
			// Kenney's Blocky Characters explicitly declare texCoord: 0, which is
			// the default UV set and is fully supported here. Only warn for an
			// actual custom UV set that this r128 loader cannot select.
			if ( transform.texCoord !== undefined && transform.texCoord !== 0 ) {
