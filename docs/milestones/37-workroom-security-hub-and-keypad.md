...
- Merge the former Workshop and Cold Room room zones, lighting, camera labels, patrol route, and player-facing copy into one `WORKROOM`.
...
- [x] Looking at the physical PIN pad and pressing `E` opens a focus-safe overlay; digit, clear, enter, keyboard, click, and touch controls remain at least 44px and fit without horizontal overflow at 390×844. — test: `scripts/test-mr-feast-workroom-security-hub.mjs::real keypad input and mobile layout`
