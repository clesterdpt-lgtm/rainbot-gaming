...
check("48 resume reclaims look", /function reclaimLookControl\(/.test(mansion) && /reclaimLookControl\(\)/.test(section("function setMenuOpen(open)", "function activateCurrentInteraction()")) && /pointerdown/.test(mansion) && /requestPointerLock/.test(section("function setMenuOpen(open)", "function activateCurrentInteraction()")), "closing the Escape menu does not re-request pointer lock for camera look");
