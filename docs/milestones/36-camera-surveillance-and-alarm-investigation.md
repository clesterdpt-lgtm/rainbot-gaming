...
- [x] Camera bodies, green/rest and red/warning fixture colors, solid-red tracking, and the suspicion HUD remain visibly readable in rendered desktop pixels and on the 390×844 touch layout with no new console errors. — test: `scripts/test-mr-feast-camera-security.mjs::desktop and mobile presentation`
