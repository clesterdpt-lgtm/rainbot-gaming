...
5. Sneak behind Mr. Feast and press E/touch Interact once to take the moving physical keyring instantly. Approaching from the front is refused. A sound distraction (throwable, piano, laundry wringer, or service bell) can still pull him away and make the rear approach easier, but it is no longer required. A valid interaction has no hold or timed-action window.
...
- Key interaction from in front: `Sneak behind him and take the keyring.`
- Key interaction behind but out of reach: `Get closer from behind and take the keyring.`
...
- An approach from in front of Mr. Feast cannot take the keys.
- One rear, close-range E/touch interaction immediately adds the keyring to the Bag and removes it from his waist in the same input turn, with no sound-distraction requirement.
...
- Focused browser QA covers the feast key visual, escape tip, locked-door clue, front refusal, undistracted rear theft, door unlock, and the complete conditional boiler/gate route. The existing Victory Feast and distraction regressions remain green.
