...
| ✅ Live | **Scrap Circuit: Last Chassis Standing** | PS1-era arena vehicular combat parody. Ten unhinged service vehicles, six destructible arenas, weapon pickups, signature specials, and an insurance-adjuster announcer. Rendered at 270p with vertex wobble, fog, and dither on purpose. `/games/scrap-circuit.html` |
