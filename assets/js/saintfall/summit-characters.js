...
export const SUMMIT_CHARACTERS = [
  {
    ...
    description: "A lean expedition plate built for rapid traversal and future paired hybrid arms.",
    accent: "verdigris",
  ...
  },
  {
    ...
    description: "A heavier crimson plate prepared for the hammer-and-shield combat kit.",
    accent: "crimson",
