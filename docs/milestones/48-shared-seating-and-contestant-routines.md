...
- [x] Standing, walking, and seated arm layers include the complete shoulder-to-hand chain; hands stay separated on their anatomical sides, standing wrists hang below the shoulders, and walking adds a bounded `0.105rad` opposing counter-swing while each signed palm normal remains aligned toward the torso by at least `0.70` throughout the swing. — test: `scripts/test-mr-feast-seating-and-routes.mjs::coherent arm-chain, procedural swing, and inward walking-palm probes`
