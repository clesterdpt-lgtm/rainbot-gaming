...
export const SAINTFALL_CHARACTERS = Object.freeze([
  Object.freeze({
    ...
    summary: "Balanced speed and sustained flight, with steady handling across every district.",
    traits: Object.freeze(["BALANCED", "SUSTAINED FLIGHT", "VERSATILE"]),
    accent: "gold",
  ...
  Object.freeze({
    ...
    summary: "Fast acceleration, deeper flight reserves, and quick recovery reward constant movement.",
    traits: Object.freeze(["FAST", "DEEPER FLIGHT", "QUICK RECOVERY"]),
    accent: "verdigris",
  ...
  Object.freeze({
    ...
    summary: "Heavy momentum and a powered leap favor deliberate, committed advances.",
    traits: Object.freeze(["HEAVY", "HIGH INERTIA", "POWERED LEAP"]),
    accent: "crimson",
