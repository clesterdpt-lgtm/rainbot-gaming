...
async function assertSourceContract() {
  ...
  assert(
    runtimeVersion.length > 0 && html.includes(`mr-feast-mansion.js?v=${runtimeVersion}`),
    `page and runtime cache identities must agree after removing gameplay breath: ${runtimeVersion}`,
  );
