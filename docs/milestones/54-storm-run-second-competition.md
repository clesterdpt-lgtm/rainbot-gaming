...
- Visual proof adds `mr-feast-{northwest-tree-line,northeast-tree-line,maze-turn}-lightning-{desktop,mobile}.png` for the three numbered reveals and `hedge-maze-north-mobile.png` for the brighter north route, alongside the desktop briefing, breadcrumb, darkness-return, and phone-layout captures.

## Exit condition

User completes Feast Says, explores for ten minutes or earns the next clue, reports to the rear terrace, hears Mr. Feast explain the race from the back door followed by an audible `3–2–1–GO`, and releases facing west. The player follows twelve mutually visible and audibly confirmed ordered yard checkpoints north through the garden and around the front without backtracking, sees Mr. Feast unmistakably appear at the northwest trees, northeast trees, and close maze turn only when facing each direction, hears a loud immediate thunder crack over briefly ducked rain, watches him vanish with the darkness, and reaches the finish before Mara to eliminate her and reopen investigation.
